...
>
> Press ⌘⇧S to instantly capture the active tab, no preview and no extra clicks.
> With the one-time macOS helper installed, it pastes straight into your Claude
> Code session in your terminal (Terminal, iTerm, VS Code, Cursor, and more), no
> ⌘V. Without the helper, it's copied to your clipboard so you can paste it into
> Claude yourself (claude.ai, Claude Desktop, or Claude Code). Want just part of
> the page? Click the toolbar icon and Crop, and it sends the moment you're done.
>
...
>   on claude.ai.
> • Install the one-time macOS helper and screenshots auto-paste right into your
>   Claude Code session, no ⌘V (on by default once the helper is set up).
>
> PRIVACY
